...
class ControlWindow(QMainWindow):
    def __init__(self, main_window):
        ...
        self.ocr_button.clicked.connect(lambda: perform_ocr(self.main_window.ocr_result_label, self.ocr_prompt, self.main_window))
    ...
    def save_image(self):
        ...
        if self.main_window.processed_image:
            save_path, _ = QFileDialog.getSaveFileName(self, "保存图片", save_folder, "PNG Files (*.png);;All Files (*)")
            if save_path:
